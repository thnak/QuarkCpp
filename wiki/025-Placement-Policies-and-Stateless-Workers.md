...
> [ADR-011](ADR-011-cluster-relay-and-placement-gate-verification) proved the
...
> [ADR-012](ADR-012-weighted-hrw-distribution-regate) proved the corrected
...
> [ADR-013](ADR-013-weighted-hrw-distribution-regate-2) then re-gated the Weighted
...
([ADR-019](ADR-019-best-effort-broadcast-publish-primitive)) is the opposite axis
