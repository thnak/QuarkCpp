...
This is the **code-and-result** companion to [023 — Performance Targets & Budgets](023-Performance-Targets-and-Budgets).
Every number below was produced by a benchmark in [`bench/`](https://github.com/thnak/QuarkCpp/tree/master/bench), built **release + native** and run
...
`[MISS]` (over the ceiling). The harness ([`bench/bench_harness.hpp`](https://github.com/thnak/QuarkCpp/blob/master/bench/bench_harness.hpp)) is the single place
...
**Code** — [`bench/mailbox_bench.cpp`](https://github.com/thnak/QuarkCpp/blob/master/bench/mailbox_bench.cpp), [`bench/sched_bench.cpp`](https://github.com/thnak/QuarkCpp/blob/master/bench/sched_bench.cpp):
...
**Code** — [`bench/ask_bench.cpp`](https://github.com/thnak/QuarkCpp/blob/master/bench/ask_bench.cpp):
...
**Code** — [`bench/stream_bench.cpp`](https://github.com/thnak/QuarkCpp/blob/master/bench/stream_bench.cpp):
...
**Code** — [`bench/activation_bench.cpp`](https://github.com/thnak/QuarkCpp/blob/master/bench/activation_bench.cpp):
...
**Code** — [`bench/serialize_bench.cpp`](https://github.com/thnak/QuarkCpp/blob/master/bench/serialize_bench.cpp) (24 B POD into a cold 64 B line strided over 64 MB > L3):
...
**Code** — [`bench/placement_bench.cpp`](https://github.com/thnak/QuarkCpp/blob/master/bench/placement_bench.cpp):
...
**Code** — [`bench/supervision_bench.cpp`](https://github.com/thnak/QuarkCpp/blob/master/bench/supervision_bench.cpp) + the `supervision_bench_noguard` control twin.
...
- **Not the deterministic gates.** The *invariant* budgets — descriptor ≤ 64 B (`static_assert`), **0 hot-path heap
  ...
  and live in [`tests/`](https://github.com/thnak/QuarkCpp/tree/master/tests) as pass/fail CTest gates, not here (a shared/noisy runner would flap a ns gate). This
