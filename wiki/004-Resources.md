...
([ADR-007](ADR-007-actor-authoring-and-handler-dispatch-api)); the
...
An inbound `Stream<F>` (see [024-Streaming-and-Inbound-Streams](024-Streaming-and-Inbound-Streams))
...
per-item heap** ([ADR-018](ADR-018-outbound-streaming-replies)).
