...
| Wire fast-path encode of a small POD message (016) | ≤ **200 ns** (near-memcpy) | ≤ 500 ns — **proven** p99 **25–28 ns** (24 B POD, 4 build cells), 0.85–1.06× `memcpy`, 0 alloc ([ADR-016](ADR-016-serialization-wire-fast-path-encode-gate)); ≤200 ns goal-stamp on reference silicon deferred |
...
Proven by [ADR-005](ADR-005-inbound-stream-ingestion-hot-path) on a
...
block. Proven by
[ADR-018](ADR-018-outbound-streaming-replies) (winner Reply-Credit-Ring /
...
[ADR-019](ADR-019-best-effort-broadcast-publish-primitive) (local fan-out,
...
Proven by [ADR-007](ADR-007-actor-authoring-and-handler-dispatch-api)
...
Proven by [ADR-008](ADR-008-engine-actor-configuration-and-activation-lifecycle-policy)
...
Proven by [ADR-009](ADR-009-failure-supervision-and-recovery-policy-model)
...
Proven by [ADR-010](ADR-010-priority-and-fairness-scheduling-policy)
