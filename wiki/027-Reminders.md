...
> [ADR-017](ADR-017-durable-reminder-mass-due-scale-gate), which won a
...
> **credit window**, not N. Reference implementation: [`reminder_service.hpp`](https://github.com/thnak/QuarkCpp/blob/master/include/quark/core/reminder_service.hpp)
...
> [PersistenceAdapters](PersistenceAdapters)); proof re-measured from a clean build on the dev box in
> [`reminder_bench.cpp`](https://github.com/thnak/QuarkCpp/blob/master/bench/reminder_bench.cpp) and gated by [`reminder_segstream_test.cpp`](https://github.com/thnak/QuarkCpp/blob/master/tests/reminder_segstream_test.cpp);
> runnable demo in [`samples/14_durable_reminders`](https://github.com/thnak/QuarkCpp/blob/master/samples/14_durable_reminders/main.cpp).
...
[`reminder_service.hpp`](https://github.com/thnak/QuarkCpp/blob/master/include/quark/core/reminder_service.hpp)):
...
**Accepted** ([ADR-017](ADR-017-durable-reminder-mass-due-scale-gate)). The load-bearing
