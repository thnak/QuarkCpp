...
design of [ADR-005](ADR-005-inbound-stream-ingestion-hot-path) (credit-ring +
...
close-out of [ADR-002](ADR-002-mailbox-mpsc-hot-path-r2)/[003](ADR-003-mailbox-mpsc-hot-path-r3)/[004](ADR-004-mailbox-mpsc-hot-path-r4)
and the admission-gate / single-executor invariant of
[015-Reentrancy-and-Quiescence](015-Reentrancy-and-Quiescence); closes the
...
5. **[extended by [ADR-018](ADR-018-outbound-streaming-replies) — outbound reply drain
