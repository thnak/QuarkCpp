...
[PERFORMANCE](PERFORMANCE) (which records measured *speed*); this file records measured
...
The exclusion logic lives in [`tests/CMakeLists.txt`](https://github.com/thnak/QuarkCpp/blob/master/tests/CMakeLists.txt) and is guarded per
