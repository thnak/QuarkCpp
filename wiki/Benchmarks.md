...
hot-path allocation*) into a **verdict a bench prints** against the [023 budgets](023-Performance-Targets-and-Budgets),
...
**Measured results, machine-of-record, and reproduce steps: [`../PERFORMANCE.md`](PERFORMANCE).**
...
[`.github/workflows/ci.yml`](https://github.com/thnak/QuarkCpp/blob/master/.github/workflows/ci.yml) alongside the four-config correctness matrix.
