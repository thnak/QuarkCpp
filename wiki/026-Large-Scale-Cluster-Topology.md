...
> **Design pinned by [ADR-006](ADR-006-large-scale-cluster-topology)** —
...
**Proven** by [ADR-011](ADR-011-cluster-relay-and-placement-gate-verification)
...
([ADR-019](ADR-019-best-effort-broadcast-publish-primitive)) that spans many
